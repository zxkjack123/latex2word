...
There is a simple table in this section (Tab. \ref{tbl:tab_exampletable}).
...
Tab. \ref{tbl:tab_table3} shows a more complex table.


\begin{table}[htbp]
    \centering
    \caption{Example Global Economic Indicators}
    \label{tbl:tab_table3}
    \begin{tabular}{l}
...
Below is an example figure (Fig. \ref{fig:multifig_examplefig}) showing a diagram that might represent a process or a conceptual flow.
...
\begin{figure}[htbp]
    ...
    \label{fig:multifig_examplefig}
\end{figure}


\subsection{Subfigures}

Below is an example of subfigures (Fig. \ref{fig:examplesubfigures}), which contains 4 subfigures (Fig. \ref{fig:multifig_examplesubfigures}(a), Fig. \ref{fig:multifig_examplesubfigures}(b), Fig. \ref{fig:multifig_examplesubfigures}(c), and Fig. \ref{fig:multifig_examplesubfigures}(d)).
...
\begin{figure}[htbp]
    ...
    \label{fig:multifig_examplesubfigures}
\end{figure}
